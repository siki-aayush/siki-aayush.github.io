    ...
    <div className="home flex flex-c flex-ac">
      ...
      <div className="home__right">
        ...
        <div className="home__right__about">
          I am a computer engineering undergraduate who is constantly eager to
          learn new things and develop solutions. I would love to develop
          products that will help people on thier daily life. I enjoy working on
          projects that are meaningful and impactful to the society. I am a huge
          fan of the anime and manga world.
